 ...
 * @author Dell
 */
public class AjoutPlat extends BaseForm{
    Form current ;
    public AjoutPlat(Resources res ) {
      super(new BorderLayout());
        ...
        TextField description = new TextField("", "Descripton", 20, TextField.EMAILADDR);
        TextField calories = new TextField("", "Calories", 20, TextField.EMAILADDR);
        TextField etat = new TextField("", "Etat", 20, TextField.EMAILADDR);
        TextField nbp = new TextField("", "Nbp", 20, TextField.EMAILADDR);
        TextField image = new TextField("", "Image", 20, TextField.EMAILADDR);
        TextField prix = new TextField("", "Prix", 20, TextField.EMAILADDR);
        TextField user = new TextField("", "user id", 20, TextField.EMAILADDR);
...
start.setType(Display.PICKER_TYPE_DATE);
        ...
        Container content = BoxLayout.encloseY(
                new Label("Ajouter Un Plat", "LogoLabel"),
   ...
   try {
                ...
                if(nom.getText().equals("") || description.getText().equals("") || calories.getText().equals("") || nbp.getText().equals("") || prix.getText().equals("") || image.getText().equals("") || etat.getText().equals("") || user.getText().equals("")) {
                    ...
                    PlatServices.getInstance().ajoutPlat(plat);
