 ...
 * @author Dell
 */
public class PlatListTri extends BaseForm1{

  Button deleteBtn,updateBtn ; 
    public static Plat currentplat = null;
   
    public PlatListTri(Resources res ) {
        ...
        add(sp);
         */
        ArrayList<Plat> rdvs = PlatServices.getInstance().TriPlat();
        for (Plat t : rdvs) {
            addElement(t , res);
        }
   ...
   private void addButton(Image img, int id, String nom, String description, String prix ) {
       ...
       String title1 =Integer.toString(id) ;
       TextArea ta =  new TextArea(title1);
       ...
       add(cnt);
       image.addActionListener(e -> ToastBar.showMessage(title1, FontImage.MATERIAL_INFO));
   }
    ...
    private void bindButtonSelection(Button b, Label arrow) {
       ...
       public void addElement(Plat plat , Resources res) {
        ...
        addButton(res.getImage("test.jpg"), plat.getId(), plat.getNom(),  plat.getDescription(), Float.toString(plat.getPrix()));
